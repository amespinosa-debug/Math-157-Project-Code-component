...
This is my submission for the Math 157 Project, specifically on the code component. My goal was to formalize the Handshaking Lemma and its proof using lists and induction rather than Mathlib's graph functions. However, I made a few adjustments that don't necessarily adhere to the proof ofthe Handshaking Lemma, but I believe demonstrates a very similar and even equivalent path.
